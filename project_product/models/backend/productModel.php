<?php 
	trait productModel{
		...
		public function model_do_edit(){
			...
			$conn = Connection::getInstance();
			//--------
			$result = $conn->prepare("update tbl_product set name=:name, category_id=:category_id,description=:description,content=:content,price=:price,hotproduct=:hotproduct where id=:id");
